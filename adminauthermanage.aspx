<%@ Page Title="" Language="C#" MasterPageFile="~/main.Master" AutoEventWireup="true" CodeBehind="adminauthermanage.aspx.cs" Inherits="libraryManagement_apps_.adminauthermanage" %>
                ...
                <div class="card mt-5 mb-3">
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col">
                                <center>
                                        <img src="imgs/man.png" style="height:100px;" class="img-fluid"/>
                        ...
                        <div class="row">
                            <div class="col-md-5">
                            <asp:Label ID="Label2" runat="server" Text="Auther Id"></asp:Label>
                                <center>
                            ...
                            <div class="col-md-7">
                            <asp:Label ID="Label1" runat="server" Text="Auther Name"></asp:Label>
                                <center>
                                       <div class="form-group">                                        
                                           <asp:TextBox ID="TextBox4" class="form-control" placeholder="Full Name" runat="server" TextMode="SingleLine"></asp:TextBox>
                                       </div>                                
                                </center>
                            </div>
                        </div>
